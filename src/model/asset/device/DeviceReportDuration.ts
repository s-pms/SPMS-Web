...
export class DeviceReportDuration extends AirEnum {
  ...
  static readonly ONE_MONTH = new DeviceReportDuration(AirConstant.SECOND_PER_DAY * AirConstant.DAY_PER_MONTH, '近一个月')

  static readonly THREE_MONTH = new DeviceReportDuration(AirConstant.SECOND_PER_DAY * AirConstant.DAY_PER_MONTH * 3, '近三个月')

  static readonly HALF_YEAR = new DeviceReportDuration((AirConstant.SECOND_PER_DAY * AirConstant.DAY_PER_YEAR) / 2, '近半年')

  static readonly ONE_YEAR = new DeviceReportDuration(AirConstant.SECOND_PER_DAY * AirConstant.DAY_PER_YEAR, '近一年')

  static readonly THREE_YEAR = new DeviceReportDuration(AirConstant.SECOND_PER_DAY * AirConstant.DAY_PER_YEAR * 3, '近三年')
